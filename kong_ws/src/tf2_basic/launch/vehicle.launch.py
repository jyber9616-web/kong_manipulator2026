...
def generate_launch_description():
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            "/world/empty/model/vehicle_1/joint_state@sensor_msgs/msg/JointState@gz.msgs.Model",
            ...
            "/world/empty/model/vehicle_test/joint_state@sensor_msgs/msg/JointState@gz.msgs.Model",
        ...
        remappings=[
            (
                "/world/empty/model/vehicle_1/joint_state",
                "/joint_states",
            ),
            (
                "/world/empty/model/vehicle_test/joint_state",
                "/vehicle_test/joint_states",
            ),
            (
